...
import com.cyf.lezu.utils.DefaultRationale
import com.cyf.lezu.utils.PermissionSetting
import com.cyf.lezu.utils.WxUtil
...
fun Context.initActionBar(act: AppCompatActivity, title: String, showBack: Boolean = true, rightBtn: String? = null,
                          rightClick: ((v: View) -> Unit)? = null, leftBtn: String? = null,
                          leftClick: ((v: View) -> Unit)? = null) {
    ...
    if (leftBtn != null) {
        ...
        act.toolbarLeftBtn.setOnClickListener { leftClick?.invoke(it) }
    } else {
    ...
    if (rightBtn != null) {
        ...
        act.toolbarRightBtn.setOnClickListener { rightClick?.invoke(it) }
    } else {
